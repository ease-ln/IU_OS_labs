...
Algorithm:  1. Sort stable processes by arrival time
...
//comparator for stable quicksort
...
int main(){
    ...
    scanf("%d", &n);
    //check whatever n is positive or not
    /*if(n<0){
    ...
    scanf("%d", &pro[i].at);
        //check whatever at is positive or not
        /*if(pro[i].at<0){
    ...
    scanf("%d", &pro[i].bt);
        //check whatever bt is positive or not
        /*if(pro[i].bt<0){
        printf("BT can not be less than 0");
        return 0;
        }*/
    }
    //stable quick sort of processes by pro[i].at
